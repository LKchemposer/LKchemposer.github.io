...
An argument has the form: "premise(s); therefore, conclusion." A fallacy is an invalid or faulty argument. Valid arguments 

A fallacy doesn't mean that the conclusion is wrong, but only that the conclusion cannot be supported by the premises. For each fallacy, 
...
* When is it OK? When there are *truly* 2 options (e.g., existence), but that premise isn't true most of the time.
...
* When is it OK? When the person's [trustworthiness, competence, or sincerity](https://core.ac.uk/download/pdf/84725205.pdf) is directly affected by the property (e.g., a pathological liar as a trial witness).
* How to avoid? 
...
<img src='/images/fallacies/post_hoc_ergo_propter_hoc.png' width='40%'/>
...
<img src='/images/fallacies/relativist_fallacy.jpeg' width='50%'/>
...
<img src='/images/fallacies/composition_division.gif' width='30%'/>
...
* Common form: "If A, then B. B is true. Therefore, A is true."
* Examples
    - "People "
    - 
* Recommendation: 
...
(Steps)[https://www.wm.edu/offices/auxiliary/osher/course-info/classnotes/shawintroductioninformallogicalfallacies.pdf]